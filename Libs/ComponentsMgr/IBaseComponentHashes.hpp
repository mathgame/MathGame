...
u_int64_t IBaseComponent::GetTypeHash(const std::pair<T1, T2>& notUsed, u_int32_t x, u_int32_t y, u_int32_t d)
{
...
///////////////////////////////////////////////////////////////////////////
template<typename T>
u_int64_t IBaseComponent::GetTypeHash(const std::vector<T>& notUsed, u_int32_t x, u_int32_t y, u_int32_t d)
{
...
u_int64_t IBaseComponent::GetTypeHash(const std::map<KeyT, ValT>& notUsed, u_int32_t x, u_int32_t y, u_int32_t d)
{
